export const buildPath = async (response: any) => {
    ...
    const concatenation = [['france']].concat(pathFromCountryGender, pathFromCountryDepartment, pathFromCountryRole, pathFromCountryRoleGender, pathFromCountryDepartmentRoleGender, pathFromCountryDepartmentRole, pathFromDepartmentGender)
