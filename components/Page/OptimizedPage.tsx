        ...
        <>
            <div className="grid grid-cols-12 gap-4 px-4 sm:px-6 lg:px-8">
                <div className="col-start-2 col-span-10">
                    ...
                    <p className="text-s text-blue-grey-700 mt-2">{`How much does a ${props.gender? props.gender: ''} ${props.role ? props.role : 'Software Engineer'} make in the ${props.area ? props.area : props.country}?`}</p>
                </div>
            </div>
            ...
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="mt-8 flex flex-col grid grid-cols-12">
                    <div className="col-start-2 col-span-10">
                        <p className="mt-2 text-s text-blue-grey-700">{`The average salary for a ${props.gender? props.gender: ''} ${props.role ? props.role : 'Software Engineer'} in ${props.area ? props.area : props.country} is ${props.compensation} €, and the median salary is ${props.median} €`}</p>
                    </div>
                </div>
            </div>
        </>
