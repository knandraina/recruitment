    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 px-4 content-center">
                <div>
                    <p className="text-blue-grey-100 mt-2 text-center">Average salary</p>
                    <p className="text-xl text-light-blue-400 text-center">{props.compensation} €</p>
                    <p className="text-blue-grey-100 mt-2 text-center">Median salary</p>
                    <p className="text-xl text-light-blue-400 text-center">{props.median} €</p>
                </div>
            </div>
