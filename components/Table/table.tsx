...
const Table = (props: TableProps) => {
    return (
        <div className="px-4 sm:px-6 lg:px-8">
            ...
            {window.location.pathname === '/' ? '' : <p className='text-xs text-blue-grey-200 mt-2'>Currently, we don&apos;t have enough data to disclose company name. For privacy reason, we will divulge company name only when we have more than 3 answers in the same company</p>}
