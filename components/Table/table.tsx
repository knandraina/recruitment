                                    ...
                                    {props.compensation ? props.compensation.post.map((transaction: any) => (
                                        <tr key={transaction._id}>
                                            ...
                                            <td className="whitespace-nowrap px-2 py-2 text-xs font-medium text-blue-grey-900 hover:text-blue-grey-200">
                                                <Link href={`/salary/france/${transaction.gender.toLowerCase()}`}>
                                                    <a className=''>{transaction.gender}</a>
                                                </Link>
                                            </td>
                                            <td className="whitespace-nowrap px-2 py-2 text-xs font-medium text-blue-grey-900 hover:text-blue-grey-200">
                                                {<Link href={`/salary/france/${transaction.category_role}`}><a>{transaction.category_role}</a></Link>}
                                            </td>
                                            ...
                                            <td className="whitespace-nowrap px-2 py-2 text-xs text-blue-grey-500 hover:text-blue-grey-200"> <Link href={`/salary/france/${transaction.department.toLowerCase()}`}><a>{transaction.department}</a></Link></td>
