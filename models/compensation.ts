...
const CompensationSchema = new Schema<ICompensation>({
    ...
    category_role: { type: String, enum: ['Software Engineer', 'DevOps', 'AdminSys', 'Data Analyst', 'Site Reliability Engineer', 'Data Scientist', 'Software Architect', 'Support'], required: true },
